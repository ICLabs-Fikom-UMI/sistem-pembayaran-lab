      ...
      <div class="col-auto col-md-3 col-xl-2 px-sm-0 px-0 bg">
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
          ...
          <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            <li class="nav-item">
              <a href="<?= BASEURL ?>/Berandakp" class="nav-link align-middle px-2">
                <i class="fs-4"><img style="width: 23px; height: auto" src="<?= BASEURL ?>/assets/img/Beranda-icon.png" alt="logo-sipemla" /></i>
                <span class="ms-1 d-none d-sm-inline">Dashboard</span>
              </a>
            </li>
            <li>
              <a href="<?= BASEURL ?>/Datamahasiswakp" class="nav-link px-2 align-middle">
            ...
            <li>
              <a href="<?= BASEURL ?>/Matakuliahkp" class="nav-link px-2 align-middle">
            ...
            <li>
              <a href="<?= BASEURL ?>/Pembayarankp" class="nav-link px-2 align-middle">
